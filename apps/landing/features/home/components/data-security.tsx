  ...
  return (
    <div className="relative w-screen bg-primary">
      <SectionContainer>
        ...
        <div className="flex flex-col sm:flex-col md:flex-col lg:flex-col xl:flex-row 2xl:flex-row justify-between gap-8 sm:gap-12 md:gap-16 lg:gap-16 xl:gap-24 2xl:gap-24">
