...
export function ClinicIssues(): JSX.Element {
  return (
    <div className="w-screen bg-foreground">
      <SectionContainer>
        <h2 className="text-background text-5xl sm:text-5xl md:text-5xl lg:text-5xl xl:text-[64px] 2xl:text-[64px] font-extrabold mb-2xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2 gap-10">
          {clinicIssues.map((item) => (
            <div key={item.title}>
              ...
              <p className="font-bold text-[32px] text-background mb-sm mt-md">
                {item.title}
              </p>
