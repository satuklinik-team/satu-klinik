  ...
  return (
    <div className="w-screen bg-background">
      <SectionContainer className="flex flex-col items-center">
        ...
        <h2 className="text-secondary text-center text-4xl sm:text-5xl md:text-5xl lg:text-5xl xl:text-[60px] 2xl:text-[60px] font-extrabold mt-5 mb-[32px] sm:mb-xl md:mb-[64px] lg:mb-[64px] xl:mb-[79px] 2xl:mb-[79px]">
